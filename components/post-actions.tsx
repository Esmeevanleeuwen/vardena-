...
type Props = { postId: string; title: string; likes: number; dislikes: number; vote: number; signedIn: boolean; available: boolean; messageTo?: string; shareUrl: string };
export function PostActions(props: Props) {
  ...
  return <div className="post-interactions">
    ...
    {!props.available ? <p className="muted small-copy">Reacties kunnen nu niet worden geladen.</p> : null}
